      ...
      <div className="w-[99.2%] pl-2 ">
        <ul className="flex items-center bg-white px-3">
          ...
          <form onSubmit={handleSearch}>
            <div className=" pl-80 relative flex justify-center items-center ">
              <input
                type="text"
                className="bg-[#F3F3F3] pl-3  py-1.5"
                placeholder="Search"
                value={search}
              ...
              <div className="pl-40 absolute cursor-pointer">
                ...
                >
                  <path
                    fill-rule="evenodd"
                    clip-rule="evenodd"
                    d="M7.98719 0C12.2514 0 15.7083 3.42502 15.7083 7.65C15.7083 9.45606 15.0766 11.1159 14.0202 12.4246L17.1728 15.549C17.5078 15.8809 17.5078 16.4191 17.1728 16.751C16.8635 17.0575 16.3769 17.081 16.0404 16.8218L15.9595 16.751L12.8061 13.6275C11.4853 14.6741 9.81003 15.3 7.98719 15.3C3.72296 15.3 0.266113 11.875 0.266113 7.65C0.266113 3.42502 3.72296 0 7.98719 0ZM7.98719 1.70007C4.67057 1.70007 1.98192 4.36398 1.98192 7.65007C1.98192 10.9362 4.67057 13.6001 7.98719 13.6001C11.3038 13.6001 13.9925 10.9362 13.9925 7.65007C13.9925 4.36398 11.3038 1.70007 7.98719 1.70007Z"
                    fill="#211F3B"
                  />
                </svg>
              </div>
